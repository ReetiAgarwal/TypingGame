  ...
  return (
    <>
        ...
        <img src={bg} alt="" className="bg" />
            <form onSubmit={handleSubmit} className="single-content">
...
// const getcloud = () => "Typing practice sentences can help improve your typing speed and accuracy".split(" ").sort(()=>Math.random()>0.5?1:-1)
